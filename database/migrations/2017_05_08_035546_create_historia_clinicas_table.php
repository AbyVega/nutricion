...
class CreateHistoriaClinicasTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Historia_clinicas", 'historia_clinicas', 'fecha_historia', 'fa-bar-chart-o', [
            ["fecha_historia", "Fecha", "Date", true, "", 0, 0, true],
        ]);
    ...
    {
        if (Schema::hasTable('historia_clinicas')) {
