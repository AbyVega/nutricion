...
<body class="hold-transition login-page">
    ...
    @if (count($errors) > 0)
        <div class="alert alert-danger">
            <strong>&iexcl;Ups!</strong> Hubo algunos problemas con tus datos.<br /><br />
            <ul>
    ...
    <p class="login-box-msg">Ingresa para iniciar sesi&oacute;n</p>
   ...
   <!-- <a href="{{ url('/password/reset') }}">Olvid&eacute; mi contrase&ntilde;a</a><br>-->
    <?php /*<!--<a href="{{ url('/register') }}" class="text-center">Register a new membership</a>-->*/ ?>
