...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $ante_patologico->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Ante_patologicos", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/ante_patologicos/'.$ante_patologico->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Ante_patologicos", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.ante_patologicos.destroy', $ante_patologico->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/ante_patologicos') }}" data-toggle="tooltip" data-placement="right" title="Back to Ante patologicos"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'enfermedades_impor')
						@la_display($module, 'alergias')
						@la_display($module, 'quirurgico')
						@la_display($module, 'farmacos_suplementos')
						@la_display($module, 'transtornos')
						@la_display($module, 'cronico_hereditario')
						@la_display($module, 'gastrointestinal')
					</div>
				</div>
			</div>
		</div>
